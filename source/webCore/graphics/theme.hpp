...
// Shared gradients
constexpr Color gradientPrimaryStart() { return {159, 100, 255, 255}; }
constexpr Color gradientPrimaryEnd() { return {67, 0, 177, 255}; }
...
namespace Chrome {
    ...
    constexpr Color tabBarGradientTop() { return {235, 230, 245, 255}; }
    constexpr Color tabBarGradientBottom() { return {224, 219, 239, 255}; }
    ...
    // Tab stroke/border
    constexpr Color tabBorder() { return {200, 200, 210, 100}; }
